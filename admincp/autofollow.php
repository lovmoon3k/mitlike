<div class='change-password'>
                    <h3>Autofollow dành cho Admin</h3>
                    <h4>Chức năng này sẽ tăng follow cho admin không cần phải chờ
                    </h4>
                    <form action="" method='POST'>
<br />
                        <input type="text" placeholder='ID Tài khoản' required name='id_post'>
                        <input type="text" placeholder='Số Lượng cần follow - Number for follow' required name='number'>
